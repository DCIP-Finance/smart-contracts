...
contract RiseToken is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x5328203d197f4a76be997D46CE61B3CB8ae719a8); // Marketing Address
    ...
    string private _name = "RiseToken";
    string private _symbol = "RISETOK";
